# 2_awq_p3llm_8pe_v2_dequant_rne

[`2_awq_p3llm_8pe_v2`](../2_awq_p3llm_8pe_v2)의 axis-3(dequant_rne) 변형이다.

| 축 | 디렉토리 | 출력 |
|---|---|---|
| ① base | `2_awq_p3llm_8pe_v2` | raw INT32 (`o_acc`) |
| ② acc16 | `2_awq_p3llm_8pe_v2_acc16` | raw INT16 |
| ③ dequant_rne | **이 디렉토리** | BF16 / FP16 activation (`o_result`) |

- top: `int4bf16_pcu32_dq` (`int4fp16_pcu32_dq`는 FP16 대조군)
...
cycle마다 오고 batch는 8 cycle이므로 여유가 있다. 정지 불가능한 raw
