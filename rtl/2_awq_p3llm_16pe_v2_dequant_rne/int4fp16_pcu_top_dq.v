...
// with PCU-local dequantization.  Same structure as int4bf16_pcu_top_dq with
// the scale and output format in binary16; retained for matched arithmetic
// experiments, while the synthesis rows use the BF16 top.
module int4fp16_pcu_top_dq (
    ...
    int4float_pcu_dq #(.EXP_W(5), .MANT_W(10), .GUARD(8), .NUM_PES(16))
        u_pcu (.*);
endmodule
