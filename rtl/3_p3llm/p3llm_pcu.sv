...
module p3llm_pcu (
  ...
  output logic [32'd511:32'd0]  acc_out
`ifdef P3LLM_DEBUG
  ,
...
`endif
  ...
  logic signed [32'd31:32'd0] pe_acc_out
    [32'd0:PCU_NUM_PES-32'd1];
...
`endif
      ...
      always_comb begin
        acc_out[pe_index*32'd32 +: 32'd32] = pe_acc_out[pe_index];
      end
    end
  endgenerate
