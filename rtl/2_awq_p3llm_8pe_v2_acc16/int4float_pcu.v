...
//
// This v2 eight-PE build accepts one independent four-bit zero point per PE.
// AutoAWQ stores weight zero points per output channel and group; broadcasting
// one zero point to all eight output PEs (the v1 DATE contract) therefore does
// not implement the standard AutoAWQ metadata layout.  Only this metadata
...
// rtl/2_awq_p3llm_8pe_v2 is the accumulator: each PE rounds its 4-lane
