...
// SpinQuant W4A4 PIM compute unit, acc16 variant: projection-layer GEMV,
// compute datapath only. Identical to rtl/5_spinquant apart from the
// accumulator width -- ACC_W = 16 with an RNE narrow in front of the
// accumulate adder, which is documented in spinquant_pe.sv.
//
