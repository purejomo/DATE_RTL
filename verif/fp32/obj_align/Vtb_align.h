...
#ifndef VERILATED_VTB_ALIGN_H_
#define VERILATED_VTB_ALIGN_H_  // guard

#include "verilated.h"

class Vtb_align__Syms;
class Vtb_align___024root;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vtb_align VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    Vtb_align___024root* const rootp;
    ...
    explicit Vtb_align(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vtb_align(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vtb_align();
  private:
    VL_UNCOPYABLE(Vtb_align);  ///< Copying not allowed
